...
sources above 15-sigma, so FermiFAST can quickly (in 90 seconds)
...
The question arises it is possible to do better. We can reduce the
...
associations in the 3PSC to increase but also for the completeless to
increase as well.  We can used the empirical distance distribution for
...
the completeness and purity of the samples.  The distribution of the
close matches here is somewhat different than in
...
\begin{figure}
  ...
  \caption{The cumulative distribution of distances between sources in
    ...
    The curves that start above zero and join each cumulative
...
Jeremy Heyl would like to thank Elisa Antolini for the 
conversations that formed the impetus for this paper.  The software
